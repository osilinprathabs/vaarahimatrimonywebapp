@extends('shared.base', ['title' => 'Light Menu']) @section('html_attribute') data-menu-color="light" data-topbar-color="dark" @endsection @section('styles') @endsection @section('content')
<!-- Begin page -->
<div class="wrapper">
    ...
    <div class="content-page">
        <div class="container-fluid">
            @include('shared.partials.page-title', ['title' => 'Light Menu'])
