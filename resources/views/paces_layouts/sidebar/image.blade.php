@extends('shared.base', ['title' => 'Image Menu']) @section('html_attribute') data-menu-color="image" data-topbar-color="light" @endsection @section('styles') @endsection @section('content')
<!-- Begin page -->
<div class="wrapper">
    ...
    <div class="content-page">
        <div class="container-fluid">
            @include('shared.partials.page-title', ['title' => 'Image Menu'])
