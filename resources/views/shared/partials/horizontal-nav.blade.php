                ...
                <ul class="navbar-nav">
                        ...
                        <div aria-labelledby="topnav-main" class="dropdown-menu">
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-dashboards" class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/dashboard/analytics') }}"><span data-lang="dashboard-analytics">Analytics</span></a>
                                    <a class="dropdown-item" href="{{ url('/dashboard/crm') }}"><span data-lang="dashboard-crm">CRM</span></a>
                                    <a class="dropdown-item" href="{{ url('/dashboard/finance') }}"><span data-lang="dashboard-finance">Finance</span></a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div aria-labelledby="topnav-apps" class="dropdown-menu">
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-ecommerce" class="dropdown-menu dropdown-menu-columns">
                                    <div class="dropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/apps/ecommerce/checkout') }}"><span data-lang="apps-ecommerce-checkout">Checkout</span></a>
                                    <div class="dropdown">
                                    ...
                                    <div class="dropdown">
                                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-inventory" role="button">
                                            <span data-lang="inventory">Inventory</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div aria-labelledby="topnav-submenu-inventory" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ url('/apps/ecommerce/warehouse') }}"><span data-lang="apps-ecommerce-warehouse">Warehouse</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/ecommerce/product-stocks') }}"><span data-lang="apps-ecommerce-product-stocks">Product Stocks</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/ecommerce/purchased-orders') }}"><span data-lang="apps-ecommerce-purchased-orders">Purchased Orders</span></a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-reports" role="button">
                                            <span data-lang="reports">Reports</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div aria-labelledby="topnav-submenu-reports" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ url('/apps/ecommerce/product-views') }}"><span data-lang="apps-ecommerce-product-views">Product Views</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/ecommerce/sales') }}"><span data-lang="apps-ecommerce-sales">Sales</span></a>
                                        </div>
                                    </div>
                                    <a class="dropdown-item" href="{{ url('/apps/ecommerce/attributes') }}"><span data-lang="apps-ecommerce-attributes">Attributes</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/ecommerce/settings') }}"><span data-lang="apps-ecommerce-settings">Settings</span></a>
                                </div>
                            </div>
                            <a class="dropdown-item" href="{{ url('/apps/chat') }}"><span data-lang="apps-chat">Chat</span></a>
                            <div class="dropdown">
                                <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-projects" role="button">
                                    <span data-lang="projects">Projects</span>
                                    <div class="menu-arrow"></div>
                                </a>
                                <div aria-labelledby="topnav-submenu-projects" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ url('/apps/projects/grid') }}"><span data-lang="apps-projects-grid">My Projects</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/projects/list') }}"><span data-lang="apps-projects-list">Projects List</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/projects/details') }}"><span data-lang="apps-projects-details">View Project</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/projects/kanban') }}"><span data-lang="apps-projects-kanban">Kanban Board</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/projects/team-board') }}"><span data-lang="apps-projects-team-board">Team Board</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/projects/activity') }}"><span data-lang="apps-projects-activity">Activity Steam</span></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-tasks" role="button">
                                    <span data-lang="tasks">Tasks</span>
                                    <div class="menu-arrow"></div>
                                </a>
                                <div aria-labelledby="topnav-submenu-tasks" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ url('/apps/task/list') }}"><span data-lang="apps-task-list">Task List</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/task/details') }}"><span data-lang="apps-task-details">Task Details</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/task/create') }}"><span data-lang="apps-task-create">Create Task</span></a>
                                </div>
                            </div>
                            <div class="dropdown">
                            ...
                            <div class="dropdown">
                                <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-finance" role="button">
                                    <span data-lang="finance">Finance</span>
                                    <div class="menu-arrow"></div>
                                </a>
                                <div aria-labelledby="topnav-submenu-finance" class="dropdown-menu">
                                    <div class="dropdown">
                                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-expenses" role="button">
                                            <span data-lang="expenses">Expenses</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div aria-labelledby="topnav-submenu-expenses" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ url('/apps/finance/expenses') }}"><span data-lang="apps-finance-expenses">Expenses</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/finance/expense-category') }}"><span data-lang="apps-finance-expense-category">Expense Category</span></a>
                                        </div>
                                    </div>
                                    <a class="dropdown-item" href="{{ url('/apps/finance/income') }}"><span data-lang="apps-finance-income">Income</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/finance/transactions') }}"><span data-lang="apps-finance-transactions">Transactions</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/finance/banks-cards') }}"><span data-lang="apps-finance-banks-cards">Banks &amp; Cards</span></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-hrm" role="button">
                                    <span data-lang="hrm">HRM</span>
                                    <div class="menu-arrow"></div>
                                </a>
                                <div aria-labelledby="topnav-submenu-hrm" class="dropdown-menu">
                                    <div class="dropdown">
                                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-staffs" role="button">
                                            <span data-lang="staffs">Staffs</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div aria-labelledby="topnav-submenu-staffs" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ url('/apps/hrm/staffs') }}"><span data-lang="apps-hrm-staffs">Staffs List</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/hrm/staff-profile') }}"><span data-lang="apps-hrm-staff-profile">Staff Profile</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/hrm/staff-add') }}"><span data-lang="apps-hrm-staff-add">Add Staffs</span></a>
                                        </div>
                                    </div>
                                    <a class="dropdown-item" href="{{ url('/apps/hrm/departments') }}"><span data-lang="apps-hrm-departments">Departments</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/hrm/attendance') }}"><span data-lang="apps-hrm-attendance">Attendance</span></a>
                                    <div class="dropdown">
                                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-leaves" role="button">
                                            <span data-lang="leaves">Leaves</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div aria-labelledby="topnav-submenu-leaves" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ url('/apps/hrm/leaves') }}"><span data-lang="apps-hrm-leaves">Leaves</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/hrm/leave-add') }}"><span data-lang="apps-hrm-leave-add">Add Leave</span></a>
                                        </div>
                                    </div>
                                    <a class="dropdown-item" href="{{ url('/apps/hrm/holidays') }}"><span data-lang="apps-hrm-holidays">Holidays</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/hrm/payroll') }}"><span data-lang="apps-hrm-payroll">Payroll</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/hrm/create-salary-slip') }}"><span data-lang="apps-hrm-create-salary-slip">Create Salary Slip</span></a>
                                </div>
                            </div>
                            <div class="dropdown">
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-support-center" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ url('/apps/ticket/list') }}"><span data-lang="apps-ticket-list">Ticket List</span></a>
                            ...
                            <div class="dropdown">
                                <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-promo" role="button">
                                    <span data-lang="promo">Promo</span>
                                    <div class="menu-arrow"></div>
                                </a>
                                <div aria-labelledby="topnav-submenu-promo" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ url('/apps/promo/coupons') }}"><span data-lang="apps-promo-coupons">Coupons</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/promo/gift-cards') }}"><span data-lang="apps-promo-gift-cards">Gift Cards</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/promo/discounts') }}"><span data-lang="apps-promo-discounts">Discounts</span></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-more-apps" role="button">
                                    <span data-lang="more-apps">More Apps</span>
                                    <div class="menu-arrow"></div>
                                </a>
                                <div aria-labelledby="topnav-submenu-more-apps" class="dropdown-menu dropdown-menu-columns">
                                    <a class="dropdown-item" href="{{ url('/apps/social-feed') }}"><span data-lang="apps-social-feed">Social Feed</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/pro-ai') }}"><span data-lang="apps-pro-ai">Pro AI</span></a>
                                    ...
                                    <a class="dropdown-item" href="{{ url('/apps/companies') }}"><span data-lang="apps-companies">Companies</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/todo') }}"><span data-lang="apps-todo">Todo</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/pin-board') }}"><span data-lang="apps-pin-board">Pin Board</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/clients') }}"><span data-lang="apps-clients">Clients</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/outlook') }}"><span data-lang="apps-outlook">Outlook View</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/vote-list') }}"><span data-lang="apps-vote-list">Vote List</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/issue-tracker') }}"><span data-lang="apps-issue-tracker">Issue Tracker</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/api-keys') }}"><span data-lang="apps-api-keys">API Keys</span></a>
                                    <a class="dropdown-item" href="{{ url('/apps/manage') }}"><span data-lang="apps-manage">Manage Apps</span></a>
                                    <div class="dropdown">
                                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-blog" role="button">
                                            <span data-lang="blog">Blog</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div aria-labelledby="topnav-submenu-blog" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ url('/apps/blog/list') }}"><span data-lang="apps-blog-list">Blog List</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/blog/grid') }}"><span data-lang="apps-blog-grid">Blog Grid</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/blog/article') }}"><span data-lang="apps-blog-article">Article</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/blog/add') }}"><span data-lang="apps-blog-add">Add Article</span></a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-forum" role="button">
                                            <span data-lang="forum">Forum</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div aria-labelledby="topnav-submenu-forum" class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ url('/apps/forum/view') }}"><span data-lang="apps-forum-view">Forum View</span></a>
                                            <a class="dropdown-item" href="{{ url('/apps/forum/post') }}"><span data-lang="apps-forum-post">Forum Post</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div aria-labelledby="topnav-custom-pages" class="dropdown-menu">
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-pages" class="dropdown-menu dropdown-menu-columns">
                                    <a class="dropdown-item" href="{{ url('/pages/about-us') }}"><span data-lang="pages-about-us">About Us</span></a>
                                    <a class="dropdown-item" href="{{ url('/pages/contact-us') }}"><span data-lang="pages-contact-us">Contact Us</span></a>
                                    ...
                                    <a class="dropdown-item" href="{{ url('/pages/gallery') }}"><span data-lang="pages-gallery">Gallery</span></a>
                                    <a class="dropdown-item" href="{{ url('/pages/faq') }}"><span data-lang="pages-faq">FAQ</span></a>
                                    <a class="dropdown-item" href="{{ url('/pages/sitemap') }}"><span data-lang="pages-sitemap">Sitemap</span></a>
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-plugins" class="dropdown-menu dropdown-menu-columns">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/plugins/idle-timer') }}"><span data-lang="plugins-idle-timer">Idle Timer</span></a>
                                    ...
                                    <a class="dropdown-item" href="{{ url('/plugins/masonry') }}"><span data-lang="plugins-masonry">Masonry</span></a>
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-authentication" class="dropdown-menu">
                                    ...
                                    <div class="dropdown">
                                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-auth-card" role="button">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div aria-labelledby="topnav-components" class="dropdown-menu">
                            ...
                            <div class="dropdown">
                                <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-widgets" role="button">
                                    <span data-lang="widgets">Widgets</span>
                                    <div class="menu-arrow"></div>
                                </a>
                                <div aria-labelledby="topnav-submenu-widgets" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ url('/widgets/charts') }}"><span data-lang="widgets-charts">Charts</span></a>
                                    <a class="dropdown-item" href="{{ url('/widgets/mixed') }}"><span data-lang="widgets-mixed">Mixed</span></a>
                                    <a class="dropdown-item" href="{{ url('/widgets/social') }}"><span data-lang="widgets-social">Social</span></a>
                                    <a class="dropdown-item" href="{{ url('/widgets/statistics') }}"><span data-lang="widgets-statistics">Statistics</span></a>
                                    <a class="dropdown-item" href="{{ url('/widgets/weather') }}"><span data-lang="widgets-weather">Weather</span></a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-charts" class="dropdown-menu">
                                    ...
                                    <div class="dropdown">
                                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-item dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" id="topnav-submenu-echarts" role="button">
                                            <span data-lang="echarts">Echarts</span>
                                            <div class="menu-arrow"></div>
                                        </a>
                                        <div aria-labelledby="topnav-submenu-echarts" class="dropdown-menu dropdown-menu-columns">
                                            <a class="dropdown-item" href="{{ url('/charts/echart/line') }}"><span data-lang="charts-echart-line">Line</span></a>
                                            <a class="dropdown-item" href="{{ url('/charts/echart/bar') }}"><span data-lang="charts-echart-bar">Bar</span></a>
                                            <a class="dropdown-item" href="{{ url('/charts/echart/pie') }}"><span data-lang="charts-echart-pie">Pie</span></a>
                                            <a class="dropdown-item" href="{{ url('/charts/echart/scatter') }}"><span data-lang="charts-echart-scatter">Scatter</span></a>
                                            <a class="dropdown-item" href="{{ url('/charts/echart/geo-map') }}"><span data-lang="charts-echart-geo-map">GEO Map</span></a>
                                            <a class="dropdown-item" href="{{ url('/charts/echart/gauge') }}"><span data-lang="charts-echart-gauge">Gauge</span></a>
                                            <a class="dropdown-item" href="{{ url('/charts/echart/candlestick') }}"><span data-lang="charts-echart-candlestick">Candlestick</span></a>
                                            <a class="dropdown-item" href="{{ url('/charts/echart/area') }}"><span data-lang="charts-echart-area">Area</span></a>
                                            <a class="dropdown-item" href="{{ url('/charts/echart/radar') }}"><span data-lang="charts-echart-radar">Radar</span></a>
                                            <a class="dropdown-item" href="{{ url('/charts/echart/heatmap') }}"><span data-lang="charts-echart-heatmap">Heatmap</span></a>
                                            <a class="dropdown-item" href="{{ url('/charts/echart/other') }}"><span data-lang="charts-echart-other">Other</span></a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-forms" class="dropdown-menu dropdown-menu-columns">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/form/cropper') }}"><span data-lang="form-cropper">Image Cropper</span></a>
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-icons" class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/icons/remix') }}"><span data-lang="icons-remix">Remix</span></a>
                                    <a class="dropdown-item" href="{{ url('/icons/solar-duotone') }}"><span data-lang="icons-solar-duotone">Solar Duotone</span></a>
                            ...
                            <div class="dropdown">
                                ...
                                <div aria-labelledby="topnav-submenu-maps" class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ url('/maps/google') }}"><span data-lang="maps-google">Google Maps</span></a>
