...
<section class="about-txt" style="background-image: url({{ asset('assets/images/logo/premium-services-bg.jpg') }}); padding-bottom: 50px; padding-top: 50px;">
    <div class="container">
        ...
        <p>1. These terms and conditions shall govern your use of our website www.vaarahimatrimony.com and Sri Vaarahi Matrimony App in Google play store.</p>
        <p>1.1. By using our website and Sri Vaarahi Matrimony App, you accept these terms and conditions in full; accordingly, if you disagree with these terms and conditions or any part of these terms and conditions, you must not use our website and Sri Vaarahi Matrimony App.</p>
        <p>1.2. If you register with our website or Sri Vaarahi Matrimony App, submit any material to our website or Sri Vaarahi Matrimony App or use any of our website services, we will ask you to expressly agree to these terms and conditions.</p>
