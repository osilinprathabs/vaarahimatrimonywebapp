...
<section class="about-txt" style="background-image: url({{ asset('assets/images/logo/premium-services-bg.jpg') }}); padding-bottom: 50px; padding-top: 50px;">
    <div class="container">
        ...
        <p>1. These terms and conditions shall govern your use of our website www.vaarahimatrimony.com and Vaarahi Matrimony App in Google play store.</p>
        <p>1.1. By using our website and Vaarahi Matrimony App, you accept these terms and conditions in full; accordingly, if you disagree with these terms and conditions or any part of these terms and conditions, you must not use our website and Vaarahi Matrimony App.</p>
        <p>1.2. If you register with our website or Vaarahi Matrimony App, submit any material to our website or Vaarahi Matrimony App or use any of our website services, we will ask you to expressly agree to these terms and conditions.</p>
        <p>1.3. You must be at least [18] years of age up to use our website and Vaarahi Matrimony App.</p>
        
        <h3>2. Licence to use website and Vaarahi Matrimony App</h3>
