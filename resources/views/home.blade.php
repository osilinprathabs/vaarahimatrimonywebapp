...
@section('content')
  ...
  .section-title {
    ...
    <rs-module id="rev_slider_1_1" data-version="6.1.2" class="rev_slider_1_1_height">
      ...
      <rs-slide data-key="rs-2" data-title="Slide" data-thumb="{{ asset('assets/images/slides/banner2.png') }}" data-anim="ei:d;eo:d;s:d;r:0;t:boxrandomrotate;sl:d;">

        <img src="{{ asset('assets/images/slides/banner2.png') }}" title="slider-main-img03" width="1263" height="500" class="rev-slidebg" data-no-retina>
  ...
  <rs-slide data-key="rs-5" data-title="Slide" data-thumb="{{ asset('assets/images/slides/banner1.png') }}" data-anim="ei:d;eo:d;s:d;r:0;t:boxrandomrotate;sl:d;">

  <img src="{{ asset('assets/images/slides/banner1.png') }}" title="slider-main-img04" width="1263" height="500" class="rev-slidebg" data-no-retina>
  ...
  <div class="container">
    ...
    <div class="col-lg-7">
      <div class="wel-txt">
 <h3>Welcome to Vaarahi Matrimony !</h3>
...
<strong>வாராஹி மேட்ரிமோனி</strong>யின் உன்னத நோக்கமாகும்.
</p>
...
அமைய எங்கள் மனமார்ந்த வாழ்த்துக்கள்.
    ...
    <div class="col-lg-5">
      ...
      <div class="layer-content">
        ...
        <form id="request_form" name="myForm" class="request_form wrap-form clearfix" method="post" action="{{ route('register') }}">
        @csrf
        <div class="row">
          <div class="col-md-12">
          ...
          <div class="col-lg-12">
          <label>
            <span class="text-input"><input name="email" type="email" value="" placeholder="Enter Email" required="required"></span>
        ...
        <div class="row">
          ...
          <label>
            ...
            <input type="text" name="mobileno" id="mobileno" required maxlength="10" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" placeholder="Enter Phone Number" />
            
            <div class="input-group-addon" style="color: #fff;background: linear-gradient(135deg, #e00c84 0%,#a90771 50%,#5d0156 100%) !important;position: relative;right: 0;margin-top: -14px;border-top-right-radius: 5px;border-bottom-right-radius: 5px;">
            <a href="#"><button type="button" id="btn_otp" class="btn btn-sendotp" style="color: #fff;padding: 13px;"> Send OTP</button></a>
            </div>
            </span>
          </label>
          </div>
          ...
          <label>
            ...
            <input type="password" name="password" id="password" placeholder="Password" data-size="8" rel="gp" data-character-set="a-z,A-Z,0-9,@#$%^&+=!, \[email protected]~" required>
        ...
        <div class="col-lg-12" style="margin-top: -15px;">
          <label>
            <span class="text-input">
            <input type="tel" id="otp" required name="otp" maxlength="4" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" placeholder="Enter OTP" title="">
            </span>
          </label>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <label>
            <span class="text-input">
            <input name="radio-1" type="radio" value="Yes I Will Be There." checked="checked">By registering, I agree to the <span> T&C</span> and <span>Privacy Policy</span>
            </span>
          </label>
          </div>
        </div>

        <button class="submit ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-skincolor w-100" id="saveBtn" type="submit">Register Now</button>
        </form>
      </div>
      </div>
    </div>
  ...
  <!--features-section-->
  <section class="ttm-row features-section clearfix" style="background-image: url('{{ asset('assets/images/logo/premium-services-bg.jpg') }}')">
    <div class="container">
    <!--row-->
    <div class="row">
      <div class="col-md-12">
      <div class="featuredbox-number">
        ...
        <div class="col-md-6">
          <h3>What Makes Vaarahi Matrimony Special?</h3>
        ...
        <div class="col-md-10">
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="featured-icon">
              <div class="ttm-icon ttm-icon_element-onlytxt ttm-icon_element-color-skincolor ttm-icon_element-style-rounded ttm-icon_element-size-md">
        ...
        <div class="col-md-10">
          ...
          <div class="col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="featured-content">
              ...
              <div class="featured-desc">
              <p>Vaarahi Matrimony website provides you a 100% secure platform to meet your life partner</p>
              </div>
            </div>
            </div><!--featured-icon-box end-->
          </div>
...
புரோக்கர் கமிஷனும் நாங்கள் வசூலிப்பதில்லை.
        ...
        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-white" href="#">View details</a>
      </div>
      </div>
    </div> <!--row end-->
    </div>
