    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm" style="border-radius: 12px;">
            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0 fw-bold"><i class="ti ti-star me-2 text-warning"></i>Available Membership Plans</h5>
                <button class="btn btn-primary px-4 fw-bold" data-bs-toggle="modal" data-bs-target="#addPlanModal" style="border-radius: 8px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        @if($plan->image)
                                            <img src="{{ asset('uploads/'.$plan->image) }}" class="rounded me-2" width="40" height="40" style="object-fit: cover;">
                                        @else
                                ...
                                <td><span class="fw-bold text-primary fs-15">₹{{ number_format($plan->amount, 2) }}</span></td>
                                <td><span class="badge bg-info-subtle text-info px-2 py-1 border border-info-subtle">{{ $plan->validity }} Days</span></td>
                                <td>
                                    <div class="d-flex flex-column gap-1">
                                        <small class="text-muted"><i class="ti ti-message me-1"></i>{{ $plan->messages ?? 0 }} Messages</small>
                                        <small class="text-muted"><i class="ti ti-heart me-1"></i>{{ $plan->interest ?? 0 }} Interests</small>
                                    </div>
                                </td>
                                <td class="text-center pe-4">
                                    <div class="d-flex justify-content-center gap-1">
                                        <button class="btn btn-sm btn-success-subtle text-success edit-plan-btn" 
                                                ...
                                                data-bs-target="#editPlanModal" title="Edit Plan">
                                            <i class="ti ti-edit"></i>
                                        </button>
                                        <button class="btn btn-sm btn-danger-subtle text-danger" title="Delete Plan">
