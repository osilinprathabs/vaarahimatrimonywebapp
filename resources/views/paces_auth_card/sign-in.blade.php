                        ...
                        <div class="col-lg-6">
                            <div class="card-body">
                                ...
                                <form>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input form-check-input-light fs-14" id="rememberMe" type="checkbox" />
                                            <label class="form-check-label" for="rememberMe">Keep me signed in</label>
                                        </div>
                                        <a class="text-decoration-underline link-offset-3 text-muted" href="{{ url('/auth-card/reset-pass') }}">Forgot Password?</a>
                                    </div>
                                    <div class="d-grid">
                                ...
                                <p class="text-muted text-center mt-4 mb-0">
                                    New here?
                                    <a class="text-decoration-underline link-offset-3 fw-semibold" href="{{ url('/auth-card/sign-up') }}">Create an account</a>
                                </p>
